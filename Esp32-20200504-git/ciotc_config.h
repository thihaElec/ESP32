...
const char *ssid = "XXX"; //add your info
const char *password = "XXXXXXX";  //add your info

// Cloud iot details.
const char *project_id = "XXXXXX"; //add your info
const char *location = "us-central1"; 
const char *registry_id = "reg20200504"; //add your info
const char *device_id = "esp32-device"; //add your info
...
const char *private_key_str =
    ...
    "XX:XX:XX:XX:XX:XX:XX:XX:XX:XX:ZZ:XX:XX:XX:XX:"
    "XX:XX";
